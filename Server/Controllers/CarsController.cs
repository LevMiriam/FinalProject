...
namespace Server.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        //[HttpGet("FilterCars")]
        //public IActionResult FilterCars(string location = null, int? seats = null, string model = null)
        //{
        //    var filteredCars = _blManager.BlCars.GetAllCars();

        //    if (!string.IsNullOrEmpty(location))
        //    {
        //        filteredCars = filteredCars.Where(car => car.Location == location).ToList();
        //    }

        //    if (seats.HasValue)
        //    {
        //        filteredCars = filteredCars.Where(car => car.Seats == seats.Value).ToList();
        //    }

        //    if (!string.IsNullOrEmpty(model))
        //    {
        //        filteredCars = filteredCars.Where(car => car.Model == model).ToList();
        //    }
